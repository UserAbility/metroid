...
[XmlRoot("XMLCollection")]
 public class XMLContainer
 {
    ...
    public static void createXML(string nesTileByte, string nesImagePath,string areaName)
    {
        ...
        XElement NESTiles =
//new XElement("NESTiles", new XElement("NESTile", new XAttribute("mappedData", nesTileByte), new XElement("tileByte", nesTileByte), new XElement("imagePath", nesImagePath), new XElement("areaName", areaName)),
...
new XElement("NESTile", new XAttribute("mappedData", "02"), new XElement("tileByte", "02"), new XElement("imagePath", @"Assets\Resources\Materials\sprite-textures\10x_hall-blue-160x160.png"), new XElement("areaName", "BRINSTAR"), new XElement("prefabMappedName", "br-c-hall-blue")),
...
new XElement("NESTile", new XAttribute("mappedData", "0D"), new XElement("tileByte", "0D"), new XElement("imagePath", @"Assets\Resources\Materials\sprite-textures\10x_balls-blue-160x160.png"), new XElement("areaName", "BRINSTAR"), new XElement("prefabMappedName", "br-c-balls-blue")),
...
new XElement("NESTile", new XAttribute("mappedData", "1A"), new XElement("tileByte", "1A"), new XElement("imagePath", @"Assets\Resources\Materials\sprite-textures\10x_pillbrick-blue-160x160.png"), new XElement("areaName", "BRINSTAR"), new XElement("prefabMappedName", "br-c-pillbrick-blue")),
new XElement("NESTile", new XAttribute("mappedData", "1B"), new XElement("tileByte", "1B"), new XElement("imagePath", @"Assets\Resources\Materials\sprite-textures\10x_tubeHori-white-160x160.png"), new XElement("areaName", "BRINSTAR"), new XElement("prefabMappedName", "br-m-pillar-hori-aqua")),
...
new XElement("NESTile", new XAttribute("mappedData", "22"), new XElement("tileByte", "22"), new XElement("imagePath", @"Assets\Resources\Materials\sprite-textures\10x_ball-red-160x160.png"), new XElement("areaName", "BRINSTAR"), new XElement("prefabMappedName", "br-c-ball")),
...
new XElement("NESTile", new XAttribute("mappedData", "2B"), new XElement("tileByte", "2B"), new XElement("imagePath", @"Assets\Resources\Materials\10x_pillar-aqua-160x160.png"), new XElement("areaName", "BRINSTAR"), new XElement("prefabMappedName", "br-m-pillar-hori-aqua")),
...
new XElement("NESTile", new XAttribute("mappedData", "2F"), new XElement("tileByte", "2F"), new XElement("imagePath", @"Assets\Resources\Materials\sprite-textures\10x_tubeHori-white-160x160.png"), new XElement("areaName", "BRINSTAR"), new XElement("prefabMappedName", "br-c-balls-blue")),
new XElement("NESTile", new XAttribute("mappedData", "30"), new XElement("tileByte", "30"), new XElement("imagePath", @"Assets\Resources\Materials\sprite-textures\10x_bubble-lone-purple-160x160.png"), new XElement("areaName", "BRINSTAR"), new XElement("prefabMappedName", "br-c-bubble-lone-purple")),
...
new XElement("NESTile", new XAttribute("mappedData", "33"), new XElement("tileByte", "33"), new XElement("imagePath", @"Assets\Resources\Materials\sprite-textures\10x_foam-aqua-160x160.png"), new XElement("areaName", "BRINSTAR"), new XElement("prefabMappedName", "br-c-foam-aqua")),
...
new XElement("NESTile", new XAttribute("mappedData", "35"), new XElement("tileByte", "35"), new XElement("imagePath", @"Assets\Resources\Materials\sprite-textures\10x_tubeHori-white-160x160.png"), new XElement("areaName", "BRINSTAR"), new XElement("prefabMappedName", "br-m-tube-aqua-hori")),
