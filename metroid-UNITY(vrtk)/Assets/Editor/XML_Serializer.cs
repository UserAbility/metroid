...
new XElement("NESTile", new XAttribute("mappedData", "2F"), new XElement("tileByte", "2F"), new XElement("imagePath", @"Assets\Resources\Materials\sprite-textures\10x_tubeHori-white-160x160.png"), new XElement("areaName", "BRINSTAR"), new XElement("prefabMappedName", "br-m-balls-blue")),
