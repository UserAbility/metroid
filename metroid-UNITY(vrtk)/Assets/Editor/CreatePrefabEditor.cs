                ...
                for (x = 0; x < jagged[y].Length - 1; x++)
                {
                    ...
                    if (byteCount < structure.Count)
                    {
                        ...
                        switch (prefabName)
                        {
                            ...
                            case "Monster statue part":
                                break;

                            case @"
":
                                break;
                            case "Elevator cable left":
                                break;
                            case "Elevator cable right":
                                break;
                            default:
            ...
            for (int y = 0; y < jagged.Length - 1; y++)
            {
                for (int x = 0; x < jagged[y].Length - 1; x++)
                {
                    ...
                    if (byteCount < structure.Count)
                    {
                        ...
                        childTileObject = NestedPrefab.Instantiate(Resources.Load(prefabName.Replace("_", "-")), new Vector3(x * 2, y * 2, 0), Quaternion.Euler(0, 0, -180)) as GameObject;
    ...
    {
        GameObject childTileObject = null;
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-ball"), new Vector3(0 + 0, (-2 + 0), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-balls-blue"), new Vector3(0 + 1, (-2 + 0), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-balls-green"), new Vector3(0 + 2, (-2 + 0), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-balls-purple"), new Vector3(0 + 3, (-2 + 0), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-brick-aqua"), new Vector3(0 + 4, (-2 + 0), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-brick-green"), new Vector3(0 + 5, (-2 + 0), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-brick-orange"), new Vector3(0 + 6, (-2 + 0), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-brick-white"), new Vector3(0 + 7, (-2 + 0), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-brush-aqua"), new Vector3(0 + 0, (-2 + 1), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-brush-orange"), new Vector3(0 + 1, (-2 + 1), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-brush-purple"), new Vector3(0 + 2, (-2 + 1), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-brush-white"), new Vector3(0 + 3, (-2 + 1), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-bubble-green"), new Vector3(0 + 4, (-2 + 1), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-bubble-lone-purple"), new Vector3(0 + 5, (-2 + 1), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-bubble-purple"), new Vector3(0 + 6, (-2 + 1), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-bubble-quad-green"), new Vector3(0 + 7, (-2 + 1), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-bubble-quad-purple"), new Vector3(0 + 0, (-2 + 2), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-bush-aqua"), new Vector3(0 + 1, (-2 + 2), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-bush-blue"), new Vector3(0 + 2, (-2 + 2), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-bush-blueB"), new Vector3(0 + 3, (-2 + 2), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-bush-green"), new Vector3(0 + 4, (-2 + 2), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-bush-greenB"), new Vector3(0 + 5, (-2 + 2), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-bush-orange"), new Vector3(0 + 6, (-2 + 2), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-bush-purple"), new Vector3(0 + 7, (-2 + 2), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-circle-blue"), new Vector3(0 + 0, (-2 + 3), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-circle-purple"), new Vector3(0 + 1, (-2 + 3), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-cloud"), new Vector3(0 + 2, (-2 + 3), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-cube-blue"), new Vector3(0 + 3, (-2 + 3), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-cube-white"), new Vector3(0 + 4, (-2 + 3), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-cubeplate-green"), new Vector3(0 + 5, (-2 + 3), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-cubeplate-purple"), new Vector3(0 + 6, (-2 + 3), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-cubeplate-white"), new Vector3(0 + 7, (-2 + 3), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-cubeQuad-white"), new Vector3(0 + 0, (-2 + 4), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-elevatorA"), new Vector3(0 + 1, (-2 + 4), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-elevatorB"), new Vector3(0 + 2, (-2 + 4), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-fangL-purple"), new Vector3(0 + 3, (-2 + 4), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-fangL-white"), new Vector3(0 + 4, (-2 + 4), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-fangR-purple"), new Vector3(0 + 5, (-2 + 4), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-fangR-white"), new Vector3(0 + 6, (-2 + 4), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-fence-green"), new Vector3(0 + 7, (-2 + 4), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-fence-purple"), new Vector3(0 + 0, (-2 + 5), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-foam-aqua"), new Vector3(0 + 1, (-2 + 5), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-foam-blue"), new Vector3(0 + 2, (-2 + 5), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-foam-green"), new Vector3(0 + 3, (-2 + 5), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-foam-orange"), new Vector3(0 + 4, (-2 + 5), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-hall-blue"), new Vector3(0 + 5, (-2 + 5), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-hall-purple"), new Vector3(0 + 6, (-2 + 5), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-lava-orange-base"), new Vector3(0 + 7, (-2 + 5), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-lava-orange-top"), new Vector3(0 + 0, (-2 + 6), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-lava-pink-base"), new Vector3(0 + 1, (-2 + 6), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-lava-pink-top"), new Vector3(0 + 2, (-2 + 6), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-lava-red-base"), new Vector3(0 + 3, (-2 + 6), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-lava-red-top"), new Vector3(0 + 4, (-2 + 6), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-lava-yellow-base"), new Vector3(0 + 5, (-2 + 6), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-lava-yellow-top"), new Vector3(0 + 6, (-2 + 6), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-oliveB"), new Vector3(0 + 7, (-2 + 6), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-oliveS"), new Vector3(0 + 0, (-2 + 7), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-pillar-aqua"), new Vector3(0 + 1, (-2 + 7), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-pillar-orange"), new Vector3(0 + 2, (-2 + 7), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-pillbrick-blue"), new Vector3(0 + 3, (-2 + 7), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-pillbrick-white"), new Vector3(0 + 4, (-2 + 7), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-pillbrick2-white"), new Vector3(0 + 5, (-2 + 7), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-pipe_aquaA"), new Vector3(0 + 6, (-2 + 7), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-pipe_aquaB"), new Vector3(0 + 7, (-2 + 7), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-pipe_blueA"), new Vector3(0 + 0, (-2 + 8), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-pipe_blueB"), new Vector3(0 + 1, (-2 + 8), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-pipe_orangeA"), new Vector3(0 + 2, (-2 + 8), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-pipe_orangeB"), new Vector3(0 + 3, (-2 + 8), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-port-floorA"), new Vector3(0 + 4, (-2 + 8), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-port-floorB"), new Vector3(0 + 5, (-2 + 8), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-pot-aqua"), new Vector3(0 + 6, (-2 + 8), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-pot-blue"), new Vector3(0 + 7, (-2 + 8), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-pot-red"), new Vector3(0 + 0, (-2 + 8), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-pot-white"), new Vector3(0 + 1, (-2 + 9), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-rock-aqua"), new Vector3(0 + 2, (-2 + 9), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-rock-orange"), new Vector3(0 + 3, (-2 + 9), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-rock-pink"), new Vector3(0 + 4, (-2 + 9), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-rock-purple"), new Vector3(0 + 5, (-2 + 9), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-rock2-aqua"), new Vector3(0 + 6, (-2 + 9), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-rock2-orange"), new Vector3(0 + 7, (-2 + 9), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-rockL-aqua"), new Vector3(0 + 0, (-2 + 10), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-rockL-orange"), new Vector3(0 + 1, (-2 + 10), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-rockR-blue"), new Vector3(0 + 2, (-2 + 10), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-rockR-orange"), new Vector3(0 + 3, (-2 + 10), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-seal-blue"), new Vector3(0 + 4, (-2 + 10), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-seal-green"), new Vector3(0 + 5, (-2 + 10), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-seal-orange"), new Vector3(0 + 6, (-2 + 10), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-spikecube-blue"), new Vector3(0 + 7, (-2 + 10), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-spikecube-white"), new Vector3(0 + 0, (-2 + 11), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-spine-blue"), new Vector3(0 + 1, (-2 + 11), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-spiral-blue"), new Vector3(0 + 2, (-2 + 11), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-spiral-orange"), new Vector3(0 + 3, (-2 + 11), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-spiral-purple"), new Vector3(0 + 4, (-2 + 11), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-spiral-white"), new Vector3(0 + 5, (-2 + 11), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-stagB-green"), new Vector3(0 + 6, (-2 + 11), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-stagB-purple"), new Vector3(0 + 7, (-2 + 11), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-stagS-green"), new Vector3(0 + 0, (-2 + 12), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-stagS-purple"), new Vector3(0 + 1, (-2 + 12), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-statue-aqua"), new Vector3(0 + 2, (-2 + 12), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-statue-norfair"), new Vector3(0 + 3, (-2 + 12), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-tile-blue"), new Vector3(0 + 4, (-2 + 12), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-tube-aqua-hori"), new Vector3(0 + 5, (-2 + 12), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-tube-aqua"), new Vector3(0 + 6, (-2 + 12), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-tube-blue"), new Vector3(0 + 7, (-2 + 12), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-tube-green"), new Vector3(0 + 0, (-2 + 13), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-tube-purple"), new Vector3(0 + 1, (-2 + 13), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-tube-white"), new Vector3(0 + 2, (-2 + 13), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-tubeHori-hole-white"), new Vector3(0 + 3, (-2 + 13), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-tubeHori-white"), new Vector3(0 + 4, (-2 + 13), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-vent-aqua"), new Vector3(0 + 5, (-2 + 13), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-vent-white"), new Vector3(0 + 6, (-2 + 13), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-weed-green"), new Vector3(0 + 7, (-2 + 13), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-weed-purple"), new Vector3(0 + 0, (-2 + 14), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-wires-blue"), new Vector3(0 + 1, (-2 + 14), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-wires-green"), new Vector3(0 + 2, (-2 + 14), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-c-wires-purple"), new Vector3(0 + 3, (-2 + 14), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-float-a1-1"), new Vector3(0 + 4, (-2 + 14), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-ball"), new Vector3(0 + 5, (-2 + 14), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-balls-blue"), new Vector3(0 + 6, (-2 + 14), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-balls-green"), new Vector3(0 + 7, (-2 + 14), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-balls-purple"), new Vector3(0 + 0, (-2 + 15), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-brick-aqua"), new Vector3(0 + 1, (-2 + 15), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-brick-green"), new Vector3(0 + 2, (-2 + 15), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-brick-orange"), new Vector3(0 + 3, (-2 + 15), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-brick-white"), new Vector3(0 + 4, (-2 + 15), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-brush-aqua"), new Vector3(0 + 5, (-2 + 15), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-brush-orange"), new Vector3(0 + 6, (-2 + 15), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-brush-purple"), new Vector3(0 + 7, (-2 + 15), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-brush-white"), new Vector3(0 + 0, (-2 + 16), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-bubble-green"), new Vector3(0 + 1, (-2 + 16), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-bubble-lone-purple"), new Vector3(0 + 2, (-2 + 16), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-bubble-purple"), new Vector3(0 + 3, (-2 + 16), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-bubble-quad-green"), new Vector3(0 + 4, (-2 + 16), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-bubble-quad-purple"), new Vector3(0 + 5, (-2 + 16), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-bush-aqua"), new Vector3(0 + 6, (-2 + 16), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-bush-orange"), new Vector3(0 + 7, (-2 + 16), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-bush-purple"), new Vector3(0 + 0, (-2 + 17), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-cube-blue"), new Vector3(0 + 1, (-2 + 17), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-cube-white"), new Vector3(0 + 2, (-2 + 17), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-cubeBrick-white"), new Vector3(0 + 3, (-2 + 17), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-cubeplate-green"), new Vector3(0 + 4, (-2 + 17), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-cubeplate-purple"), new Vector3(0 + 5, (-2 + 17), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-cubeplate-white"), new Vector3(0 + 6, (-2 + 17), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-cubeQuad-white"), new Vector3(0 + 7, (-2 + 17), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-door-blue"), new Vector3(0 + 0, (-2 + 18), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-fangL-purple"), new Vector3(0 + 1, (-2 + 18), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-fangL-white"), new Vector3(0 + 2, (-2 + 18), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-fangR-purple"), new Vector3(0 + 3, (-2 + 18), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-fangR-white"), new Vector3(0 + 4, (-2 + 18), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-foam-aqua"), new Vector3(0 + 5, (-2 + 18), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-foam-blue"), new Vector3(0 + 6, (-2 + 18), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-foam-green"), new Vector3(0 + 7, (-2 + 18), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-foam-orange"), new Vector3(0 + 0, (-2 + 19), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-foam-purple"), new Vector3(0 + 1, (-2 + 19), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-hall-blue"), new Vector3(0 + 2, (-2 + 19), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-hall-purple"), new Vector3(0 + 3, (-2 + 19), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-oliveB"), new Vector3(0 + 4, (-2 + 19), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-oliveS"), new Vector3(0 + 5, (-2 + 19), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-pillar-aqua"), new Vector3(0 + 6, (-2 + 19), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-pillar-hori-aqua"), new Vector3(0 + 7, (-2 + 19), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-pillar-hori-orange"), new Vector3(0 + 0, (-2 + 20), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-pillar-orange"), new Vector3(0 + 1, (-2 + 20), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-pillbrick-white"), new Vector3(0 + 2, (-2 + 20), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-pillbrick2-blue"), new Vector3(0 + 3, (-2 + 20), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-pillbrick2-white"), new Vector3(0 + 4, (-2 + 20), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-platform-aqua"), new Vector3(0 + 5, (-2 + 20), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-pot-aqua"), new Vector3(0 + 6, (-2 + 20), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-pot-blue"), new Vector3(0 + 7, (-2 + 20), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-pot-orange"), new Vector3(0 + 0, (-2 + 21), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-pot-white"), new Vector3(0 + 1, (-2 + 21), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-rock-aqua"), new Vector3(0 + 2, (-2 + 21), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-rock-orange"), new Vector3(0 + 3, (-2 + 21), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-rock-pink"), new Vector3(0 + 4, (-2 + 21), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-rock2-aqua"), new Vector3(0 + 5, (-2 + 21), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-rock2-orange"), new Vector3(0 + 6, (-2 + 21), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-rockL-aqua"), new Vector3(0 + 7, (-2 + 21), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-rockL-orange"), new Vector3(0 + 0, (-2 + 22), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-rockR-aqua"), new Vector3(0 + 1, (-2 + 22), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-rockR-orange"), new Vector3(0 + 2, (-2 + 22), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-seal-blue"), new Vector3(0 + 3, (-2 + 22), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-seal-green"), new Vector3(0 + 4, (-2 + 22), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-seal-red"), new Vector3(0 + 5, (-2 + 22), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-spikecube-aqua"), new Vector3(0 + 6, (-2 + 22), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-spikecube-white"), new Vector3(0 + 7, (-2 + 22), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-spiral-aqua"), new Vector3(0 + 0, (-2 + 23), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-spiral-orange"), new Vector3(0 + 1, (-2 + 23), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-spiral-purple"), new Vector3(0 + 2, (-2 + 23), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-spiral-white"), new Vector3(0 + 3, (-2 + 23), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-tile-blue"), new Vector3(0 + 4, (-2 + 23), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-towers-aqua"), new Vector3(0 + 5, (-2 + 23), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-tube-aqua-hori"), new Vector3(0 + 6, (-2 + 23), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-tube-aqua"), new Vector3(0 + 7, (-2 + 23), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-tube-blue"), new Vector3(0 + 0, (-2 + 24), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-tube-green"), new Vector3(0 + 1, (-2 + 24), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-tube-purple"), new Vector3(0 + 2, (-2 + 24), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-tube-white"), new Vector3(0 + 3, (-2 + 24), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-tubeHori-hole-white"), new Vector3(0 + 4, (-2 + 24), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-tubeHori-white"), new Vector3(0 + 5, (-2 + 24), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-vent-aqua"), new Vector3(0 + 6, (-2 + 24), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-vent-white"), new Vector3(0 + 7, (-2 + 24), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
        childTileObject = NestedPrefab.Instantiate(Resources.Load("br-m-vent-white"), new Vector3(0 + 0, (-2 + 25), 0), Quaternion.Euler(0, 0, -180)) as GameObject; childTileObject.transform.SetParent(GameObject.Find("Plane").transform, false);
    }
